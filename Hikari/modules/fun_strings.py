RUN_STRINGS = (
    "Sekarang kamu melihatku, sekarang kamu tidak.",
    "ε=ε=ε=ε=┌(;￣▽￣)┘",
    "Kembali kesini!",
    "REEEEEEEEEEEEEEEEEE!!!!!!!",
    "Awas tembok!",
...
SLAP_SAITAMA_TEMPLATES = (
    ...
    [
        "Aku membisukanmu sebentar.",  # normal reply
        "Berhentilah menamparku hanya karena aku tidak bisa membisukanmu. REEEEEEEEEE.",  # reply to admin
        "tmute",  # command
        "Diam!",
        "shut up kontol!",
    ],
...
SLAP_TEMPLATES = (
    ...
    "{user2} pingsan.",
    "{user2} Pokemon yang bisa digunakan sudah habis! {user2} kalah.",
    "{user2} Pokemon yang bisa digunakan sudah habis! {user2} blacked out!.",
    "{user2} got rekt.",
